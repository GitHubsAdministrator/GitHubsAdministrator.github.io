            ...
            <table class="table table-striped table-bordered m-top-md" id="dataTable">
				...
				<tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php foreach ($v['jsonarr']['vforum'] as $vv): ?>
                            <span class="label label-primary"><?php echo $vv;?></span>
                            <?php endforeach ?>
                            <button onclick="$('#gn').val('vforum');$('.modal-body').load('<?php HYBBS_URL('admin','forum_json',['id'=>$v['id'],'gn'=>'vforum']) ?>')" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#normalModal">编辑</button>
                        </td>
                        <td>
                            <?php foreach ($v['jsonarr']['vthread'] as $vv): ?>
                            <span class="label label-primary "><?php echo $vv;?></span>
                            <?php endforeach ?>
                            <button onclick="$('#gn').val('vthread');$('.modal-body').load('<?php HYBBS_URL('admin','forum_json',['id'=>$v['id'],'gn'=>'vthread']) ?>')" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#normalModal">编辑</button>
                        </td>
                        <td>
                            <?php foreach ($v['jsonarr']['thread'] as $vv): ?>
                            <span class="label label-primary "><?php echo $vv;?></span>
                            <?php endforeach ?>
                            <button onclick="$('#gn').val('thread');$('.modal-body').load('<?php HYBBS_URL('admin','forum_json',['id'=>$v['id'],'gn'=>'thread']) ?>')" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#normalModal">编辑</button>
                        </td>
                        <td>
                            <?php foreach ($v['jsonarr']['post'] as $vv): ?>
                            <span class="label label-primary "><?php echo $vv;?></span>
                            <?php endforeach ?>
                            <button onclick="$('#gn').val('post');$('.modal-body').load('<?php HYBBS_URL('admin','forum_json',['id'=>$v['id'],'gn'=>'post']) ?>')" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#normalModal">编辑</button>
                        </td>
                      
                        <td>
                            <?php foreach ($v['jsonarr']['downfile'] as $vv): ?>
                            <span class="label label-primary "><?php echo $vv;?></span>
                            <?php endforeach ?>
                            <button onclick="$('#gn').val('downfile');$('.modal-body').load('<?php HYBBS_URL('admin','forum_json',['id'=>$v['id'],'gn'=>'downfile']) ?>')" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#normalModal">编辑</button>
                        </td>
